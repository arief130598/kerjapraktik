            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="form-group col-md-12">
                        <div class="divsubmit">
                          <form action="<?php echo base_url(). 'submitnilailaa/inputnilai'; ?>" method="post">
                            ...
                            <label for="nilaisimilarity">Nilai Similarity</label> 
                            <input class="inputsubmit" type="number" id="nilaisimilarity" name="nilaisimilarity" placeholder="Masukan Nilai..">
                            <?php echo form_error('nilaisimilarity');?></br>
