...
<head>
    ...
    <title>Submit Permohonan - Mahasiswa</title>
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <div class="text-center">
                          <img src="<?php echo base_url ('assets/images/permohonan.png')?>" class="rounded" alt="Surat Pengantar">
                        </div>
                    ...
                    <div class="form-group col-md-12">
                        <form action="submitpermohonan/mulai_upload" enctype="multipart/form-data" method="post">
                        <div class="input-group">
                          <div class="custom-file" >
                            <input type="file" class="custom-file-input" name="permohonan">
