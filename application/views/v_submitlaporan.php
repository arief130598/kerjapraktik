            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="form-group col-md-12">
                            <span>Pastikan laporan sudah sesuai format.</span>
                            <span> Format terdapat pada buku panduan, dapat di download di : <a class="text-primary" href="dokumenkp">Dokumen KP</a></span>
                            <a></br><i class="fa fa-file-pdf-o" aria-hidden="true"></i><span>Upload File (PDF : Max 5MB)</span></a>
                    </div>
                    <div class="form-group col-md-12" >
                        <form action="submitlaporan/mulai_upload" enctype="multipart/form-data" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Nomor Handphone wajib diisi">
                        <input class="input100" type="text" name="hp" placeholder="Nomor Handphone">
                        <span class="focus-input100"></span>
                    </div>
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Password is required">
                        <input class="input100" type="text" name="lowongan" placeholder="Lowongan">
                        <span class="focus-input100"></span>
                    </div>

                  <div data-role="rangeslider">
                    <label for="price-min">Price:</label>
                    <input type="range" name="price-min" id="price-min" value="2000000" min="0" max="10000000">
                    <label for="price-max">Price:</label>
                    <input type="range" name="price-max" id="price-max" value="5000000" min="0" max="10000000">
                  </div>
                        <div class="input-group">
                          <div class="custom-file" >
                            <input type="file" class="custom-file-input" name="laporan">
